...
implementation
//**********************Début Panda************************
procedure pnjPanda (var personnage : heros);//procedure lançant la quête du panda

var
quitter: boolean; //Valeur que prend les réponses du joueur.
        ...
        case choix of
            ...
            3 :begin
                if personnage.soupe then
		            begin
			            personnage.armure:= 5000;//on recoit l'armure donnée par le panda
			            personnage.arme:= 500;//on recoit l'arme donnée par le panda
