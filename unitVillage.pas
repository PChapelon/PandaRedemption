...
var
choix,choix2:integer; //Valeur que prend les réponses du joueur.
quitter: boolean;
...
begin
  ...
  effacerEcran;
  writeln('Apres avoir explorer la foret, vous arrive dans un petit village'); //texte décrivant
  ...
  case choix of  //Premier case en rapport avec le choix de l'utlisateur
    1:begin
        ...
        writeln('avec une feuille sur la tête.');//texte
